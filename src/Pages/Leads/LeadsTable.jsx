                ...
                <table className="min-w-full">
                    <thead className="bg-[#F8FAFC]">
                        <tr>
                            ...
                            <th className="px-12 py-2 text-left rtl:text-right text-gray-500 dark:text-gray-400 font-semibold text-[16px]">
                                <span className="text-2xl font-semibold">T</span> Title
                            </th>

                            <th className="px-4 py-2 font-semibold text-[16px] text-left rtl:text-right text-gray-500 dark:text-gray-400">
