...
const TaskDetails = () => {
    return (
        <div className="md:mt-6 mt-4 bg-white rounded-xl border border-[#E7E7E7] mb-6">
            ...
            <div className="grid md:grid-cols-4 grid-cols-2 gap-5 m-6">
                <div className="flex items-center justify-between bg-[#F8FAFC] p-4 border-[#E7E7E7] rounded-lg">
                    <div className="flex items-center gap-2">
                        <FaVirus color="#CE9AFF" size={20} />
                        <h2 className="text-[16px] md:text-[20px] font-semibold">In Progress</h2>
