                    ...
                    <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                        ...
                        <tr>
                            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                <div className="inline-flex items-center gap-x-3">
                                    ...
                                    <h2 className="font-bold">Product launch campaign</h2>
                                </div>
                            </td>
                            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                <div>
                            ...
                            <td className="px-4 py-4 text-[16px] text-[#717171] whitespace-nowrap">Email</td>
                            <td className="px-4 py-4 text-sm whitespace-nowrap">
                                <div className="flex items-center gap-x-2">
                                    <p className="px-3 py-1 font-semibold text-[#166B51] rounded-full bg-[#DEF6EE]">Completed</p>
                                </div>
                            </td>
                            <td className="px-4 py-4 text-[16px] text-[#717171] whitespace-nowrap">Acme (Sample)</td>
                            <td className="px-4 py-4 text-[16px] text-[#717171]">
                                <div className="flex items-center gap-2">
                                    <img src={tablePeople} alt="" />
                                    <h2 className="font-bold  hidden xl:block">Sk Murad </h2>
                                </div>
                            </td>
                            <td className="px-4 py-4 text-sm whitespace-nowrap">
                        ...
                        <tr>
                            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                <div className="inline-flex items-center gap-x-3">
                                    <input type="checkbox" className="text-blue-500 border-gray-300 rounded dark:bg-gray-900 dark:ring-offset-gray-900 dark:border-gray-700 w-5 h-5 " />
                                    <h2 className="font-bold">Customer Conference</h2>
                                </div>
                            </td>
                            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                <div>
                            ...
                            <td className="px-4 py-4 text-[16px] text-[#717171] whitespace-nowrap">Event</td>
                            <td className="px-4 py-4 text-sm whitespace-nowrap">
                                <div className="flex items-center gap-x-2">
                                    <p className="px-3 py-1 font-semibold text-[#18137C] rounded-full bg-[#EAE9FE]">Planed</p>
                                </div>
                            </td>
                            <td className="px-4 py-4 text-[16px] text-[#717171] whitespace-nowrap">Acme (Sample)</td>
                            <td className="px-4 py-4 text-[16px] text-[#717171]">
                        ...
                        <tr>
                            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                <div className="inline-flex items-center gap-x-3">
                                    <input type="checkbox" className="text-blue-500 border-gray-300 rounded dark:bg-gray-900 dark:ring-offset-gray-900 dark:border-gray-700 w-5 h-5 " />
                                    <h2 className="font-bold">Widgets Webinar (Sample)</h2>
                                </div>
                            </td>
                            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                <div>
                            ...
                            <td className="px-4 py-4 text-[16px] text-[#717171] whitespace-nowrap">Other</td>
                            <td className="px-4 py-4 text-sm whitespace-nowrap">
                                <div className="flex items-center gap-x-2">
                                    <p className="px-3 py-1 font-semibold text-[#18137C] rounded-full bg-[#EAE9FE]">Planed</p>
                                </div>
                        ...
                        <tr>
                            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                <div className="inline-flex items-center gap-x-3">
                                    <input type="checkbox" className="text-blue-500 border-gray-300 rounded dark:bg-gray-900 dark:ring-offset-gray-900 dark:border-gray-700 w-5 h-5 " />
                                    <h2 className="font-bold">Brand awareness</h2>
                                </div>
                            </td>
                            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                <div>
...
export default RecentlyCampaigns;